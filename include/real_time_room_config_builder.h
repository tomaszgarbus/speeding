 ...
 * @brief Builder which creates a RealTimeRoomConfig.
 */
...
class GPG_EXPORT RealTimeRoomConfig::Builder {
 public:
  ...
  /**
   * The maximum number of auto-match players who can join the room.
  ...
  /**
   * Sets whether socket communication is enabled. By default socket
   * communication is disabled.
   */
  Builder &SetSocketCommunicationEnabled(bool socket_communication_enabled);

  /**
   * Populates values from a
   * <code>RealTimeMultiplayerManager::ShowPlayerSelectUIResponse</code>. Note
