...
class GPG_EXPORT RealTimeMultiplayerManager {
 public:
   ...
   * <code>RealTimeRoom</code>. The room value is only valid if
   ...
   * <code>RealTimeRoomResponse</code> from one of the turn-based multiplayer
   * operations.
   */
  ...
  /**
   * Asynchronously creates a <code>RealTimeRoom</code> using the provided
   * <code>RealTimeRoomConfig</code>. If creation is successful, this
   * function returns the <code>RealTimeRoom</code> via the provided
   ...
   * <code>RealTimeRoom</code> for the other participants, but removes the
   * <code>RealTimeRoom</code> from the local player's device.
   */
