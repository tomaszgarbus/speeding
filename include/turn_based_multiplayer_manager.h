...
class GPG_EXPORT TurnBasedMultiplayerManager {
 public:
  ...
  /**
    ...
    * {@link TakeMyTurn} during the final turn of the match. Allows the caller
    *to
    ...
    * @param match_data A blob of data representing the final state of the
    *match.
    ...
    *     <code>TakeTurn</code>. Attempting to set different results for a
    *player
