...
class GPG_EXPORT RealTimeRoomConfig {
 public:
  /**
   * Constructs a <code>RealTimeRoomConfig</code> from a
   * <code>shared_ptr</code> to a <code>RealTimeRoomConfigImpl</code>.
  ...
  /**
   * Creates a copy of an existing <code>RealTimeRoomConfig</code>.
   */
  RealTimeRoomConfig(RealTimeRoomConfig const &copy_from);

  /**
   * Moves an existing <code>RealTimeRoomConfig</code>.
   */
  RealTimeRoomConfig(RealTimeRoomConfig &&move_from);

  /**
   * Assigns this <code>RealTimeRoomConfig</code> by copying from another one.
   */
  RealTimeRoomConfig &operator=(RealTimeRoomConfig const &copy_from);

  /**
   * Assigns this <code>RealTimeRoomConfig</code> by moving another one into
   * it.
   */
  RealTimeRoomConfig &operator=(RealTimeRoomConfig &&move_from);

  /**
   * Returns true if this <code>RealTimeRoomConfig</code> is populated with
  ...
  /**
   * A flag indicating whether socket communication should be enabled for this
   * <code>RealTimeRoom</code>. Can only be called if {@link Valid} returns
   * true.
   */
  bool SocketCommunicationEnabled() const;
